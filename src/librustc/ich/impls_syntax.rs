...
impl<'a, 'gcx> HashStable<StableHashingContext<'a, 'gcx>> for InternedString {
    #[inline]
...
impl<'a, 'gcx> ToStableHashKey<StableHashingContext<'a, 'gcx>> for InternedString {
...
impl<'a, 'gcx> HashStable<StableHashingContext<'a, 'gcx>> for ast::Name {
    #[inline]
    fn hash_stable<W: StableHasherResult>(&self,
                                          hcx: &mut StableHashingContext<'a, 'gcx>,
                                          hasher: &mut StableHasher<W>) {
...
impl<'a, 'gcx> ToStableHashKey<StableHashingContext<'a, 'gcx>> for ast::Name {
    type KeyType = InternedString;
...
impl<'a, 'gcx> HashStable<StableHashingContext<'a, 'gcx>> for [ast::Attribute] {
    fn hash_stable<W: StableHasherResult>(&self,
                                          hcx: &mut StableHashingContext<'a, 'gcx>,
                                          hasher: &mut StableHasher<W>) {
        if self.len() == 0 {
...
impl<'a, 'gcx> HashStable<StableHashingContext<'a, 'gcx>> for FileMap {
    fn hash_stable<W: StableHasherResult>(&self,
                                          hcx: &mut StableHashingContext<'a, 'gcx>,
                                          hasher: &mut StableHasher<W>) {
        let FileMap {
